...
<div class="bg-paralax-pg-default">
  <div class="container">
    <h6><a href="./">home</a> &raquo; <a href="acoes-sociais-externas">acoes-sociais-externas</a></h6>
  </div>
</div>
...
<div class="container">
  ...
  <div class="my-3 p-3 bg-white rounded shadow-sm">
    <h3 class="border-bottom border-gray pb-2 mb-0">Ações sociais externas</h3>
